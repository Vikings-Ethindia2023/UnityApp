...
namespace MetaMask.Unity.Samples
{
    ...
    public class MetaMaskDemo : MonoBehaviour
    {
        ...
        {
            string msgParams = "{\"domain\": {  \"chainId\": 1,  \"name\": \"\",  \"verifyingContract\": \"0xCcCCccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC\",  \"version\": \"1\"},\"message\": {1702113268000],[48.859489, 2.32045,1702113788000],[48.859489, 2.32060,1702113458000]]\"},\"primaryType\": \"Mail\",\"types\": {  \"EIP712Domain\": [    { \"name\": \"name\", \"type\": \"string\" },    { \"name\": \"version\", \"type\": \"string\" },    { \"name\": \"chainId\", \"type\": \"uint256\" },    { \"name\": \"verifyingContract\", \"type\": \"address\" }  ] \"Mail\": [{ \"name\": \"contents\", \"type\": \"string\" }]}}";
